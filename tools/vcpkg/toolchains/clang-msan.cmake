...
set(EXTRA_CXX_FLAGS
    " -nostdinc++ -nostdlib++ -isystem ${LIBCXX_INCLUDE_DIR}/c++/v1 -L ${LIBCXX_LIB_DIR} -Wl,-rpath,${LIBCXX_LIB_DIR} -static -lc++ -lc++abi -lunwind -fuse-ld=lld -Wno-unused-command-line-argument"
)
