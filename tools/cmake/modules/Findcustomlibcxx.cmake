...
execute_process(COMMAND "${compiler}" --version OUTPUT_VARIABLE VERSION_OUTPUT)
...
if(NOT customlibcxx_POPULATED)
    ...
    execute_process(
        COMMAND
            ...
            # "-DLIBCXX_ENABLE_STATIC=ON" # "-DLIBCXX_ENABLE_SHARED=OFF" # "-DLIBCXX_ENABLE_STATIC_ABI_LIBRARY=ON" #
